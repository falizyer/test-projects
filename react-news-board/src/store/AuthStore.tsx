...
import { AuthActions, AuthStoreState, defaultAuthStoreState, IAction, AuthStoreContext } from "../store";

function reducer(state: Omit<AuthStoreState, "dispatch">, action: IAction<AuthActions>) {
    switch (action.type) {
